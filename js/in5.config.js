...
viewOpts = {"title":1,"page":1,"zoom":1,"fs":1,"pdf":"https://api-object.bluvalt.com:8082/nhcsa/MAGAZINE_V01/MAGAZINE_V01/assets/downloads/NHC_MAGAZINE_V01.pdf","toc":1,"thumbs":1,"progress":0,"showbar":1,"logo":"https://api-object.bluvalt.com:8082/nhcsa/MAGAZINE_V01/MAGAZINE_V01/assets/images/frame-logo.png","bg":"#02b095","loadText":"loading NHC...","footer":0};
...
function initWebApp(){
	...
	if(isDevice){
		if(!navigator.standalone) {
			...
			$('body').addClass('webapp-instructions').css('background','#fff)').append('<img style="'+styleStr+'" src="https://api-object.bluvalt.com:8082/nhcsa/MAGAZINE_V01/MAGAZINE_V01/assets/images/add_to_home_'+nameForDeviceFile+'.png" />');
			return !0;
		}
		...
		(location.protocol == 'file:' ? '%28Post%20to%20a%20web%20server%20to%20show%20URL%29' : location.href) +'"><img src="https://api-object.bluvalt.com:8082/nhcsa/MAGAZINE_V01/MAGAZINE_V01/assets/images/non_'+nameForNonDeviceFile+'.png';
